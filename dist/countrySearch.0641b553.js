...
function displayInfo(countryLibrary, countryQuery, uiElement) {
    ...
    if (countryQuery.toLowerCase() === "antarctica") uiElement.innerHTML = `
        ...
        `;
    else if (country) uiElement.innerHTML = `
            <div class="displayContainer">
                <div class="summaryTopRow">
                    <img class="countryFlag" src=${antarcticaDeservesItsProperFlag(country)} alt="flag">
                    <h3 class="countryName ${getContinent(country)}">${country.name.common}</h3>
        ...
        `;
    else if (countryQuery === "") uiElement.innerHTML = `   
    `;
    else uiElement.innerHTML = `
...
function currencySemantics(country) {
    ...
    for(let i = 0; i < currencyArray.length; i++){
        if (i !== 0 && i === currencyArray.length - 1) returnString += ` and ${currencyArray[i].name}s`;
        else if (i !== 0 && i < currencyArray.length) returnString += `, ${currencyArray[i].name}s`;
    }
    return returnString;
}
function languageSemantics(country) {
    ...
    for(let i = 0; i < languageArray.length; i++){
        if (i !== 0 && i === languageArray.length - 1) returnString += ` and ${languageArray[i]}`;
        else if (i !== 0 && i < languageArray.length) returnString += `, ${languageArray[i]}`;
    }
    return returnString;
}
...
//# sourceMappingURL=countrySearch.0641b553.js.map
